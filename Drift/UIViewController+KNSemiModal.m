...
-(CAAnimationGroup*)animationGroupForward:(BOOL)_forward {
    ...
    t2.m34 = t1.m34;
    t2 = CATransform3DTranslate(t2, 0, [self parentTarget].frame.size.height * -0.08f, 0);
...
-(void)presentSemiView:(UIView*)view {
    ...
    if (![target.subviews containsObject:view]) {
        ...
        [ss.layer addAnimation:[self animationGroupForward:YES]
        ...
        CGRect f = CGRectMake(0, 0, sf.size.width, sf.size.height);
