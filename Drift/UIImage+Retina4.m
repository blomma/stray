...
+ (UIImage *)retina4ImageNamed:(NSString *)imageName {
    ...
    NSString *fullPath = [[NSBundle mainBundle] retina4PathForResource:[newResourceName stringByAppendingString:@"@2x"] ofType:@"png"];
    if (fullPath) {
        return [self retina4ImageNamed:[newResourceName stringByAppendingPathExtension:@"png"]];
    } else {
